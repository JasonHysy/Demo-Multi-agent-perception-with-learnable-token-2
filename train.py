...
if __name__ == "__main__":
    ...
    for _ in range(run_times):
        ...
        elif cfg['model']['arch'] == 'LearnWhen2Com2': # Our when2com
            trainer = Trainer_LearnWhen2Com(cfg, writer, logger, model, loss_fn, trainloader, valloader, optimizer, scheduler, device)
        ...
        elif cfg['model']['arch'] == 'MIMO2':  #
            trainer = Trainer_MIMO2(cfg, writer, logger, model, loss_fn, trainloader, valloader, optimizer, scheduler, device)
        ...
        testloader = data.DataLoader(te_loader, batch_size=cfg["training"]["batch_size"], num_workers=2)
